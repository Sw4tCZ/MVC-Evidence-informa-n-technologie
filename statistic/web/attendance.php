<?php require_once "web/header.php"; ?>
    <div style="text-align: right; margin: 20px 0px 10px;">
        <a id="btnAddAction" href="index.php?action=attendance-add"><img src="web/image/icon-add.png" />Přidat statistiku</a>
    </div>
    <div id="toys-grid">
        <table cellpadding="10" cellspacing="1" class="attendance_table">
            <thead>
                <tr>
                    ...
                    <th><strong>Přítomen</strong></th>
                    <th><strong>Nepřítomen</strong></th>
                    <th></th>
